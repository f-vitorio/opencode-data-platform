...
# LANDING PAGE & WEBSITE AUDIT PRO

## OBJETIVO

Executar uma auditoria profunda, comercial e técnica de um site ou landing page.

O objetivo não é simplesmente encontrar erros.

O objetivo é descobrir:

1. o que está impedindo o site de gerar mais negócios;
2. quais oportunidades estão sendo perdidas;
3. quanto tráfego potencial pode estar sendo perdido;
4. quanto de demanda comercial pode estar sendo desperdiçada;
5. quais problemas reduzem conversão;
6. quais problemas prejudicam SEO;
7. quais problemas prejudicam Google Ads;
8. como o cliente está posicionado contra concorrentes;
9. quais oportunidades existem no Google Business Profile;
10. quais ações devem ser executadas;
11. quais serviços da agência podem resolver esses problemas.

O resultado deve funcionar simultaneamente como:
...
Para cada página comercial importante, avaliar:
...
Não fazer apenas uma avaliação geral do domínio.

Identificar problemas específicos por página.

---

# 4. PÁGINAS COMERCIAIS

Para cada serviço/produto relevante, perguntar:

1. Existe uma página específica?
2. Ela está indexada?
3. Ela possui intenção comercial clara?
4. Ela está otimizada para as keywords relevantes?
5. Ela possui CTA?
6. Ela possui prova?
7. Ela possui diferenciação?
8. Ela possui oferta clara?
9. Ela pode receber tráfego Google Ads?
10. Ela possui potencial de conversão?

Se um serviço importante não possui uma página específica:

registrar como OPORTUNIDADE ESTRUTURAL.

---

# 5. DESCOBERTA DE OPORTUNIDADES
...
# 6. QUANTO O CLIENTE ESTÁ PERDENDO
...
Quando dados não estiverem disponíveis, marcar:

"N/D".

---

# 14. COPYWRITING DO RELATÓRIO

O relatório não deve ser escrito como um laudo técnico frio.

Utilizar princípios de copywriting consultivo.

O relatório deve conduzir o leitor:
...
Não utilizar medo artificial.

Não exagerar números.

Não inventar perdas.

Mostrar claramente o custo de oportunidade.

Exemplo de lógica:

"Seu site recebe X impressões para determinadas buscas, mas gera apenas Y cliques. Isso significa que existe demanda sendo apresentada ao mercado, mas uma parte relevante dela não está chegando ao seu negócio."

Depois:

"Além disso, concorrentes próximos aparecem melhor posicionados para buscas comerciais relevantes."

Depois:

"Isso cria uma oportunidade concreta de capturar uma parcela maior dessa demanda através de SEO, Google Ads e melhoria das páginas comerciais."

---

# 15. RELATÓRIO VOLTADO PARA VENDA

O relatório deve apresentar os problemas de forma que o cliente entenda:

- o que está acontecendo;
- por que importa;
- quanto pode estar deixando de capturar;
- o que precisa ser feito;
- como a agência pode resolver.

NÃO transformar o relatório em propaganda exagerada.

A venda deve acontecer através do diagnóstico.
...
# 17. POSICIONAMENTO DA AGÊNCIA

O relatório deve posicionar a agência como especialista capaz de resolver os problemas encontrados.

Relacionar problemas com serviços relevantes.

Exemplo:

PROBLEMA:
Página comercial não captura determinada intenção.

OPORTUNIDADE:
Criar/otimizar landing page específica.

SERVIÇO RELACIONADO:
Landing Page de Alta Conversão + SEO.

---

# 18. FRONTEND / DESIGN DO RELATÓRIO
...
"Existe demanda sendo perdida."

Apresentar dados reais e estimativas claramente identificadas.

## SITE

Mapa/resumo das páginas analisadas.
...
Problemas e oportunidades de mensagem.
...
As ações com maior potencial.

## PLANO DE AÇÃO

Agora / 7 dias / 30 dias.

## COMO A AGÊNCIA PODE AJUDAR

Relacionar problemas encontrados com serviços relevantes.

## CTA FINAL

Convidar o cliente para uma conversa/análise estratégica.

---

# 21. RELATÓRIO POR PÁGINA

Para páginas comerciais prioritárias, apresentar:
...
# 26. COPY DA RECOMENDAÇÃO

Cada recomendação deve seguir:
...
"Hoje, sua página X aparece para uma demanda relevante, porém não apresenta uma oferta suficientemente alinhada à intenção comercial. Isso pode reduzir tanto o aproveitamento orgânico quanto a eficiência de campanhas pagas. A oportunidade é transformar essa página em uma página comercial específica, alinhada à busca e construída para conversão."

---

# 27. TESTES E HIPÓTESES
...
# 29. PROFUNDIDADE MÍNIMA

Uma auditoria completa deve obrigatoriamente conter:

1. inventário do site;
2. análise das páginas comerciais;
3. análise da home;
4. análise das páginas de serviço;
5. SEO;
6. OpenSEO;
7. Google Ads quando disponível;
8. GA4 quando disponível;
9. Search Console quando disponível;
10. GBP quando aplicável;
11. concorrentes locais;
12. CRO;
13. copywriting;
14. UX;
15. performance;
...
17. tracking;
18. oportunidades;
19. estimativa de perda/oportunidade;
20. plano de ação;
21. relatório HTML.
...
FASE 14
→ Construir estratégia de melhoria.
...
# 30.1. FLUXO PÓS-AUDITORIA — BANCO DE DADOS
...
### 30.1.2. VERIFICAR SE LEAD JÁ EXISTE
...
### 30.1.3. DADOS OBRIGATÓRIOS NO CLIENTS
...
### 30.1.4. DADOS OBRIGATÓRIOS NA INTERACTION
...
| followup_note | `Apresentar resultados da auditoria e propor solução` |

### 30.1.5. PAYLOAD PADRÃO — INSERT CLIENT
...
### 30.1.6. PAYLOAD PADRÃO — INSERT INTERACTION
...
### 30.1.7. COMANDO DE INSERÇÃO (EXEMPLO)
...
### CHECKLIST OBRIGATÓRIO — 13 SEÇÕES

⚠️ **Se qualquer seção estiver faltando, o relatório NÃO deve ser entregue.**

- [ ] CAPA — nome, domínio, data, agência
- [ ] 01 — Resumo em 60 Segundos (scores + 3 bullets)
- [ ] 02 — Onde Está o Dinheiro (tabela vazamento × evidência × impacto)
- [ ] 03 — O Mercado (comparativo concorrentes)
- [ ] 04 — A Demanda (keywords + gaps)
- [ ] 05 — O Site (inventário + análise por página)
...
- disclaimer está presente nas seções 08 e 09?
...
- as recomendações estão priorizadas?
- o cliente consegue entender quanto está perdendo?
- o cliente consegue entender como resolver?
...
> "Agora eu entendi exatamente onde estou perdendo oportunidades."
...
A auditoria deve ser tecnicamente rigorosa, comercialmente persuasiva, visualmente profissional e baseada em evidências.
...
Ele deve demonstrar o valor econômico e técnico de resolver os problemas encontrados com uma empresa especializada.

A FVS7 deve aparecer como a empresa capaz de conectar:
...
Quando os dados institucionais estiverem disponíveis, apresentar a FVS7 como uma operação especializada em crescimento digital, combinando:
...
A tecnologia utilizada pela FVS7 inclui:

- Astro;
- Tailwind CSS;
- arquitetura web orientada a performance;
- Google Tag Manager;
- Google Analytics 4;
...
NÃO apresentar essas tecnologias como simples lista de ferramentas.

Explicar o benefício empresarial de cada uma.

---

# 15. ASTRO

Quando houver oportunidade relacionada à performance ou arquitetura:

explicar profissionalmente que a FVS7 utiliza Astro para construir experiências web modernas e altamente performáticas.
...
"Arquitetura desenvolvida para reduzir o peso desnecessário da página, melhorar velocidade de carregamento e criar uma experiência mais eficiente para o usuário."
...
Não tratar Tailwind como benefício isolado.

Explicar que a utilização de uma arquitetura moderna de frontend permite construir interfaces:
...
A velocidade deve ser tratada como componente de negócio.
...
- menor aproveitamento do tráfego;
- perda de oportunidades;
- impacto potencial em campanhas;
...
"Processo sistemático de transformação de tráfego em oportunidades comerciais."

Explicar que CRO envolve:
...
"Não basta comprar mais tráfego. É necessário aumentar o aproveitamento do tráfego existente."

---

# 19. GOOGLE TAG MANAGER

Apresentar GTM como infraestrutura de mensuração.
...
Quando identificar problemas de tracking:

mostrar que uma campanha pode estar gerando resultado que não está sendo corretamente mensurado, ou vice-versa.

NUNCA afirmar que isso ocorre se não houver evidência.

---

# 20. GA4

Apresentar GA4 como ferramenta para entender:
...
"estrutura de mensuração capaz de transformar comportamento em informação para tomada de decisão."
...
Mostrar que eles formam um sistema.
...
3. Qual oportunidade existe.
4. O que precisa ser corrigido.
5. Por que a implementação exige conhecimento especializado.
6. Como a FVS7 pode resolver.
...
"Enquanto esta estrutura permanecer dessa forma, o investimento em aquisição continuará levando usuários para uma experiência que não está preparada para extrair todo o potencial desse tráfego."

Ou:

"A oportunidade identificada não está apenas em gerar mais visitantes, mas em aumentar o valor extraído de cada visitante que já chega ao negócio."
...
"ter uma infraestrutura digital construída para aquisição e conversão."

Apresentar a diferença de forma consultiva.
...
# 25. CONEXÃO ENTRE PROBLEMA E SERVIÇO

Cada oportunidade relevante deve apontar para uma capacidade específica da FVS7.

Exemplo:

PROBLEMA:
Landing page não possui alinhamento com a intenção comercial.

SOLUÇÃO:
Reestruturação da landing page com CRO e copy orientada à conversão.

CAPACIDADE FVS7:
Landing Pages de Alta Conversão + CRO.

---

PROBLEMA:
Site apresenta problemas de performance.

SOLUÇÃO:
Rearquitetura frontend e otimização de performance.

CAPACIDADE FVS7:
Astro + Tailwind + arquitetura performática.

---

PROBLEMA:
Conversões não estão sendo mensuradas adequadamente.

SOLUÇÃO:
Implementação/revisão de GTM + GA4 + eventos de conversão.
...
PROBLEMA:
O cliente não captura buscas comerciais relevantes.

SOLUÇÃO:
Estratégia SEO baseada em pesquisa de keywords e intenção.

CAPACIDADE FVS7:
SEO + OpenSEO + arquitetura de páginas.

---

PROBLEMA:
Google Ads envia tráfego para página pouco relevante.

SOLUÇÃO:
Alinhamento keyword → anúncio → landing page + CRO.

CAPACIDADE FVS7:
Google Ads + Landing Page + CRO.
...
Isso transforma a auditoria em uma venda consultiva.
...
NÃO basta dizer "seu CLS está alto".

O cliente precisa entender:

"CLS 0.94 na homepage está degradando a experiência do usuário. Isso pode estar reduzindo a taxa de conversão em 20-30%. Com X visitas/mês, isso representa Y leads perdidos/mês, equivalente a R$ Z de oportunidade perdida."
...
1. Usar faixas de mercado (ex: implante R$ 2.500-8.000)
2. Criar cenários por procedimento
3. Calcular ticket médio ponderado
4. Explicitar que é estimativa de mercado

Estrutura de cálculo:

| Procedimento | Faixa de Preço | Participação Estimada | Contribuição |
|---|---|---|---|
| Procedimento A | R$ X-Y | Z% | R$ valor |
| Procedimento B | R$ X-Y | Z% | R$ valor |
| **Ticket Médio Ponderado** | | | **R$ total** |
...
# ============================================================
# ESTRUTURA DO RELATÓRIO — 13 SEÇÕES COMERCIAIS
# ============================================================

# 36. ESTRUTURA DO RELATÓRIO — 13 SEÇÕES OBRIGATÓRIAS

⚠️ **REGRA ABSOLUTA:** O relatório HTML DEVE conter EXATAMENTE estas 13 seções. NENHUMA pode ser omitida. Se qualquer seção não puder ser preenchida com dados reais, usar "N/D — dado não disponível" mas A SEÇÃO DEVE EXISTIR.

O relatório HTML segue uma estrutura de 13 seções obrigatórias, organizadas por narrativa comercial:

## CAPA
- "Auditoria de Crescimento Digital"
- Pergunta de impacto: "Quanto da demanda disponível sua empresa está capturando?"
- Nome do cliente, domínio, data, agência

## 01 — RESUMO EM 60 SEGUNDOS
- Cards de score (Geral, SEO, Conversão, Performance, Mobile)
- Frase de impacto central
- 3 bullets: problema / oportunidade / caminho

## 02 — ONDE ESTÁ O DINHEIRO (Radar de Dinheiro Perdido)
- Tabela visual: Vazamento × Evidência × Impacto
- 6 categorias: Conversão, SEO, Google, Tracking, Performance, Tecnologia
- Cada problema traduzido em consequência financeira

## 03 — O MERCADO
- Comparativo visual: Cliente × 4-5 concorrentes
- Presença, avaliações, serviços, blog, diferenciais
- Insight: diferencial único do cliente

## 04 — A DEMANDA
- Keywords com CPC e intenção de busca
- GAP: keywords sem página dedicada
- Narrativa: "Existem buscas por procedimentos que a empresa não possui páginas"

## 05 — O SITE
- Inventário de páginas
- Análise por página principal
- Problema → consequência financeira

## 06 — TECNOLOGIA
- Site Convencional vs Infraestrutura de Crescimento
- Não "tecnologia X é ruim" → "a tecnologia deve ser julgada pela capacidade de sustentar crescimento"

## 07 — TRACKING
- O que não pode ser medido hoje
- Impacto: decisões baseadas em intuição vs dados

## 08 — CENÁRIO FINANCEIRO
- Funil visual: Investimento → Receita
...
## 10 — A SOLUÇÃO
- Site Convencional vs Infraestrutura de Crescimento
- Funil visual: Atrair → Receber → Convencer → Converter → Mensurar → Otimizar

## 11 — POR QUE FVS7
- 5 capacidades conectadas a problemas específicos
- Cada capacidade = problema encontrado + solução FVS7
- "Não vender tecnologia. Vender resultado."

## 12 — PLANO 90 DIAS
- Timeline visual: Semana 1-2 / Semana 3-4 / Mês 2 / Mês 3
- Ações priorizadas por impacto × esforço
- Resultado esperado em 90 dias

## 13 — PRÓXIMO PASSO
- CTA consultivo
- Contatos da agência (WhatsApp, email, telefone)
- Dados de credibilidade da agência

---

# 37. REGRA DE NARRATIVA

A narrativa do relatório deve seguir:
...
清单 de problemas técnicos sem conectar a consequências financeiras.
...
## ONDE O NEGÓCIO ESTÁ PERDENDO OPORTUNIDADES
...
Mostrar o inventário de páginas.

Depois:

páginas críticas.

Não analisar somente a home.
...
Dados provenientes de OpenSEO/Search Console quando disponíveis.
...
Mostrar somente dados efetivamente obtidos.

Exibir claramente a fonte.
...
Mostrar somente métricas efetivamente verificadas.
...
# 46. POR QUE A IMPLEMENTAÇÃO IMPORTA

Depois de demonstrar os problemas, criar uma seção:

"Por que corrigir isso exige mais do que simplesmente redesenhar o site?"

Explicar:

Uma estratégia digital eficiente precisa conectar:
...
Apresentar a FVS7 através das capacidades realmente relevantes para o diagnóstico.

Exemplo:

### PERFORMANCE

Arquitetura moderna com Astro e frontend otimizado.

### EXPERIÊNCIA

Interfaces responsivas e modernas utilizando Tailwind CSS.

### CONVERSÃO

CRO, copywriting, testes e estrutura orientada à geração de leads.

### AQUISIÇÃO

Google Ads e SEO orientados à intenção de busca.

### MENSURAÇÃO

Google Tag Manager + GA4 + eventos e conversões.

### INTELIGÊNCIA

Análise de dados, Search Console, OpenSEO e comportamento.

---

# 48. NÃO VENDER TECNOLOGIA. VENDER RESULTADO.

Nunca escrever:

"Usamos Astro porque é moderno."

Preferir:

"Utilizamos uma arquitetura moderna para reduzir complexidade desnecessária e construir páginas rápidas, responsivas e preparadas para aquisição e conversão."
...
"Utilizamos uma arquitetura frontend consistente para manter a experiência visual, responsividade e evolução das páginas sob controle."
...
"Construímos uma camada de mensuração para que decisões de marketing sejam tomadas com base no comportamento real dos usuários."
...
"O principal risco não está apenas em continuar com um site que possui problemas. O risco está em investir cada vez mais em aquisição sem corrigir a infraestrutura que recebe esse tráfego."
...
"Seu próximo ganho provavelmente não está apenas em gerar mais tráfego.

Está em transformar melhor a demanda que já existe.

A FVS7 pode transformar este diagnóstico em um plano de implementação, conectando performance, SEO, Google Ads, CRO, tracking e uma experiência digital construída para conversão."
...
[ ] GTM foi verificado quando possível.

[ ] GA4 foi verificado quando possível.

[ ] Conversões foram analisadas quando possível.

## FVS7

[ ] Dados oficiais da agência foram utilizados.

[ ] Astro foi apresentado quando relevante.

[ ] Tailwind foi apresentado quando relevante.

[ ] Performance foi apresentada como benefício de negócio.

[ ] CRO foi apresentado como metodologia.

[ ] GTM + GA4 foram apresentados como infraestrutura de mensuração.

[ ] Google Ads + SEO foram conectados ao restante da estratégia.
